/******/ (function () {
  ...
  \********************************************************************/
			/***/ function (
				...
				/* harmony import */ var _wordpress_primitives__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! @wordpress/primitives */ '@wordpress/primitives'
					);
  ...
  \***********************************************/
			/***/ function (
				...
				(0,
				_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.setCategories)([
					...(0,
					_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.getCategories)().filter(
						({ slug }) => slug !== 'learnpress'
					),
					{
						slug: 'learnpress',
						title: (0,
  ...
  \****************************************************/
			/***/ function (
				...
				/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_4__ =
					__webpack_require__(
						/*! @wordpress/icons */ './node_modules/@wordpress/icons/build-module/library/page.js'
					);
				...
				function Edit({ attributes }) {
					var _TEMPLATES$attributes;
					const blockProps = (0,
					_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)();
					const templateTitle =
						(_TEMPLATES$attributes =
							TEMPLATES[attributes.template]?.title) !== null &&
						_TEMPLATES$attributes !== void 0
							? _TEMPLATES$attributes
							: attributes.template;
					return (0,
					_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
						...
						(0,
						_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
							_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Placeholder,
							{
								icon: _wordpress_icons__WEBPACK_IMPORTED_MODULE_4__[
									'default'
								],
								label: templateTitle,
								className:
									'wp-block-learnpress-template__placeholder',
							},
							(0,
							_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(
								'div',
								{
									className:
										'wp-block-learnpress-template__placeholder-inner',
								},
								(0,
								_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.sprintf)(
  ...
  \*****************************************************/
			/***/ function (
				...
				/* harmony export */ __webpack_require__.d(
					__webpack_exports__,
					{
						/* harmony export */ metadata: function () {
							return /* reexport default export from named module */ _block_json__WEBPACK_IMPORTED_MODULE_2__;
						},
						/* harmony export */ name: function () {
							return /* binding */ name;
						},
						/* harmony export */ settings: function () {
				...
				/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_1__ =
					__webpack_require__(
						/*! ./edit */ './assets/src/apps/js/blocks/template/edit.js'
					);
				/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ =
					__webpack_require__(
						/*! ./block.json */ './assets/src/apps/js/blocks/template/block.json'
					);

				const { name } = _block_json__WEBPACK_IMPORTED_MODULE_2__;
				const settings = {
					title: 'LearnPress Template',
					keywords: ['learnpress', 'template'],
					description: (0,
					_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)(
						'Renders LearnPress PHP templates.',
						'learnpress'
					),
					icon: 'archive',
  ...
  \*******************************************************/
			/***/ function (module) {
				module.exports = JSON.parse(
					'{"apiVersion":2,"name":"learnpress/template","category":"learnpress","attributes":{"template":{"type":"string","default":""}}}'
				);
  ...
  \********************************************/
		...
		/* harmony export */ __webpack_require__.d(__webpack_exports__, {
			/* harmony export */ registerLearnPressBlocks: function () {
				return /* binding */ registerLearnPressBlocks;
			},
			/* harmony export */
		});
		/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ =
		...
		/* harmony import */ var _category__WEBPACK_IMPORTED_MODULE_1__ =
			__webpack_require__(
				/*! ./category */ './assets/src/apps/js/blocks/category.js'
			);
		/* harmony import */ var _template__WEBPACK_IMPORTED_MODULE_2__ =
			__webpack_require__(
				/*! ./template */ './assets/src/apps/js/blocks/template/index.js'
			);
